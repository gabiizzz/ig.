...
public class ControllerRev implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Image image= new Image("file:src/img/revv.png");
        view.setImage(image);
        view.setPreserveRatio(false);

        Image img = new Image("file:src/img/servoRev.png");
        servo.setImage(img);
        Image img2 = new Image("file:src/img/armRev.png");
        arm.setImage(img2);
    }
}
